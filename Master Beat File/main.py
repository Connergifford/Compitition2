...
'''
hi_hat = mixer.Sound('Master Beat File\sounds\hi hat.WAV')

snare = mixer.Sound('Master Beat File\sounds\snare.wav')
kick = mixer.Sound('Master Beat File\sounds\kick.wav')
crash = mixer.Sound('Master Beat File\sounds\crash.wav')
clap = mixer.Sound('Master Beat File\sounds\clap.wav')
tom = mixer.Sound("Master Beat File\sounds\\tom.wav")

screen = pygame.display.set_mode([WIDTH, HEIGHT])
pygame.display.set_caption('The Beat Maker')
label_font = pygame.font.Font('Master Beat File\Roboto-Bold.ttf', 32)
medium_font = pygame.font.Font('Master Beat File\Roboto-Bold.ttf', 24)
beat_changed = True
...
load_menu = False
saved_beats = []
file = open('Master Beat File\saved_beats.txt', 'r')
for line in file:
